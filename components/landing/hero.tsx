...
import { PenTool01Icon, StarIcon } from "@hugeicons/core-free-icons";
import { Button } from "@/components/ui/button";
import { Reveal } from "@/components/landing/reveal";

export function Hero() {
  return (
    <section className="flex min-h-0 flex-1 flex-col items-center justify-center gap-8 px-4 py-6 sm:gap-10 sm:px-6 lg:px-8">
      <div className="flex max-w-3xl flex-col items-center gap-5 text-center sm:gap-6">
        <Reveal>
        ...
        <Reveal delay={0.24}>
          <div className="flex flex-wrap items-center justify-center gap-3">
            ...
            >
              <HugeiconsIcon icon={PenTool01Icon} className="size-5" aria-hidden />
              Start drawing
            </Button>
          </div>
        </Reveal>
