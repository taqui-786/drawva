...
export class WidgetManager {
  ...
  private onMessage = (e: MessageEvent) => {
    if (e.data?.type === "drawva-widget-pointerdown" || e.data?.type === "penecho-widget-pointerdown") {
  ...
  private mount(widget: WidgetItem): void {
    ...
    // ---- Top Action Chrome (Floating controls positioned bit above top border) ----
    ...
    // Top-Left Group: Accept (check) + Copy
    ...
    // Top-Right Group: Remove / Reject Button
    ...
    // ---- AI Refine pill (commented out for now as requested) ----
    /*
    ...
    */
    ...
    // ---- Bottom-Right Resizable handle (Resize SVG) ----
