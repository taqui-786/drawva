...
export class WidgetManager {
  ...
  add(widget: WidgetItem): void {
    ...
    const initialW = widget.w || 640;
    const initialH = widget.h || 420;
    const contentW = widget.contentW || initialW;
    const contentH = widget.contentH || initialH;
